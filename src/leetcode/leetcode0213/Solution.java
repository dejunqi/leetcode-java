...
public class Solution {
    ...
    private int helper(int[] nums, int[] memo, int i, int end) {
        ...
        int res = Math.max(nums[i] + helper(nums, memo, i + 2, end), helper(nums, memo, i + 1, end));
        memo[i] = res;
        return res;
    }
    ...
    public void test() {
        int[] nums = {
                ...
                91,80,223,58,170,110,236,81,90,222,160,165,195,187,199,
                114,235,197,187,69,129,64,214,228,78,188,67,205,94,205,169,241,202,144,240};
